...
function App() {
  ...
  function deleteParty(partyId: string) {
    ...
    if (!party?.archived || !confirmDeletion('Tem certeza que deseja excluir esta festa? Esta ação não pode ser desfeita.')) return
